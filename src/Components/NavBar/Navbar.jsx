...
function Navbar() {
  ...
  return (
    <div>
      {/* NAVBAR */}
      <nav
        className="navbar sticky-top mx-md-0 mx-sm-0"
        aria-label="Dark offcanvas navbar">
        {/* <div className="container-fluid"> */}
        <button
          className="navbar-toggler nav-toggle-btn p-0 m-0"
          type="button"
        ...
        <div className="d-flex logoSection">
        ...
        <div className="select-layout text-white ">
          <div className="selectOperator text-white pb-0">Select Operator</div>
        ...
        <div className="input-container m-md-0 p-md-0 pe-0">
          <RiSearchLine className="search" />
          <input
            className="form-control input-search rounded-pill  ms-md-0 ms-sm-0"
            value="search"
          />
        </div>
        <div className="bell-icon m-md-0">
        ...
        <div className="navbar-brand text-white profile  d-flex" href="/">
          <div>
